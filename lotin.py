...
class KrillLotin(QtWidgets.QWidget):
    def __init__(self):
        super().__init__()
    ...
    def oyna(self):
        ...
        self.setWindowTitle("Krill-Lotin")
        self.resize(800,800)
        self.textEdit = QtWidgets.QTextEdit()
        self.textBrowser = QtWidgets.QTextBrowser()
        self.radioButton = QtWidgets.QRadioButton("Lotin")
        self.radioButton_2 = QtWidgets.QRadioButton("Крилл")
        self.label = QtWidgets.QLabel()
        self.pushButton = QtWidgets.QPushButton("O'tkazish")
        self.pushButton.setEnabled(False)
        self.pushButton_2 = QtWidgets.QPushButton("Tozala")
        self.pushButton_2.setEnabled(False)
        self.textBrowser.setFont(QFont('Times New Roman',18))
        self.textEdit.setFont(QFont('Times New Roman',18))
        self.textBrowser.setStyleSheet("background-color: #37474F;color: #E8EAF6")
        self.textEdit.setStyleSheet("background-color: #37474F;color: #E8EAF6")
        ...
        h1box.addWidget(self.radioButton)
        h1box.addWidget(self.radioButton_2)
        vbox=QtWidgets.QVBoxLayout()
        vbox.addLayout(h1box)

        
        h2box=QtWidgets.QHBoxLayout()
        h2box.addWidget(self.pushButton)
        h2box.addWidget(self.pushButton_2)
        ...
        self.radioButton_2.clicked.connect(self.och)
        self.pushButton.clicked.connect(self.otkaz)
        self.pushButton_2.clicked.connect(self.tozala)
    

    def otkaz(self):
        if self.radioButton.isChecked():
            krillcha=to_cyrillic(self.textEdit.toPlainText())
            self.textBrowser.setText(krillcha)
            self.label.setText("Tayyor")
            
        elif self.radioButton_2.isChecked():
            lotincha=to_latin(self.textEdit.toPlainText())
            self.textBrowser.setText(lotincha)
            self.label.setText("Tayyor")
